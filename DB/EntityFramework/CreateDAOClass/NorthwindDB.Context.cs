...
namespace CreateDAOClass
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncomeForSupplierAndPeriod(string companyName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncomeForSupplierAndPeriod", companyNameParameter, startDateParameter, endDateParameter);
        }
    }
}
